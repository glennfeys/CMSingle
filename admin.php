...
<!-- Content --><html><head></head>
    <body>
        ...
        .close:focus {
            ...
            <div id="myModal" class="modal">
                ...
                <span class="close">&times;</span>
                <h2>change image to...</h2>
                <select id="imgselect" onchange="setPreview()"><option value=".\CMSimpleImages\afgelast.jpg">.\CMSimpleImages\afgelast.jpg</option><option value=".\CMSimpleImages\bartm.jpg">.\CMSimpleImages\bartm.jpg</option><option value=".\CMSimpleImages\geertb.jpg">.\CMSimpleImages\geertb.jpg</option><option value=".\CMSimpleImages\lucds.jpg">.\CMSimpleImages\lucds.jpg</option></select>
                <br>
                <img id="previewImg" style="width: inherit; margin: 20px auto;" src=""/>
                <input type="submit" value="change" onclick="setImg()">
            ...
            <div id="editBar" style="position:fixed; bottom:0; right:0; z-index: 9; padding: 10px;background-color: #f7faff; box-shadow: inset -4px -5px 34px -6px rgba(0,0,0,0.67);">
                ...
                <input style="width:100%;" type="button" id="saveBtn" value="Save" onclick="saveFile()"/>
                <br>
                <br><a href="#" onclick="goTo('2eprovenciale.php')">2eprovenciale.php</a><br><a href="#" onclick="goTo('action.php')">action.php</a><br><a href="#" onclick="goTo('afgelast.php')">afgelast.php</a><br><a href="#" onclick="goTo('beloftena.php')">beloftena.php</a><br><a href="#" onclick="goTo('beloftenb.php')">beloftenb.php</a><br><a href="#" onclick="goTo('bestuur.php')">bestuur.php</a><br><a href="#" onclick="goTo('clubreglement.php')">clubreglement.php</a><br><a href="#" onclick="goTo('contacteerons.php')">contacteerons.php</a><br><a href="#" onclick="goTo('dames.php')">dames.php</a><br><a href="#" onclick="goTo('evenementen.php')">evenementen.php</a><br><a href="#" onclick="goTo('footPass.php')">footPass.php</a><br><a href="#" onclick="goTo('footer.php')">footer.php</a><br><a href="#" onclick="goTo('header.php')">header.php</a><br><a href="#" onclick="goTo('historiek.php')">historiek.php</a><br><a href="#" onclick="goTo('index.html')">index.html</a><br><a href="#" onclick="goTo('jeugdbestuur.php')">jeugdbestuur.php</a><br><a href="#" onclick="goTo('ongevalsaangifte.php')">ongevalsaangifte.php</a><br><a href="#" onclick="goTo('ouderreglement.php')">ouderreglement.php</a><br><a href="#" onclick="goTo('panathlonverklaring.php')">panathlonverklaring.php</a>
                <br>
            ...
            <script>
                ...
                function saveFile() {
                    ...
                    formData.append("file", curPage)
                    formData.append("content", document.documentElement.innerHTML)
                    formData.append("password", "admin") // TODO: insecure
    ...
    <!--CMSinglePHP1--><?php include 'header.php'; ?><!--CMSinglePHP2-->
		
		<p contenteditable="true" class="head" >Beloften A</p>
                <p contenteditable="true" class="head1" >Trainer</p>
		<p contenteditable="true" > <b>Trainer:</b> Didier Boulliaert</p>
		<p contenteditable="true" ><b>Tel.:</b> 0477 89 05 71</p>
		<p contenteditable="true" ><b>Email:</b> ----- </p>
		<br>
		<p contenteditable="true" class="head" >Afgevaardigde</p>
		<p contenteditable="true" > <b>Afgevaardigde:</b> Aaron Buysse</p>
                <p contenteditable="true" ><b>Tel.:</b> 0479 03 81 18</p>
		<br>

<!--CMSinglePHP1--><?php include 'footer.php'; ?><!--CMSinglePHP2--></body></html>