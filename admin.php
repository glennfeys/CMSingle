 ...
 * If a file is uploaded, it checks if the upload directory exists and creates it if it doesn't.
 * It then checks if the file is a valid image and if it already exists in the directory.
 * If everything is ok, it uploads the file to the target directory.
 *
 * @return void
 */
...
/**
 * Saves the edited content to file when 'Save' is pressed.
 * 
 * @return void
 */
function save(){
...
// It checks if the CSRF token is set in the session and returns it, otherwise it returns an empty string.
 ...
 * Output CSRF field.
 *
 * This function outputs a hidden input field with the name "_token" and the value of the csrf_token() function.
 *
 * @return void
 */
function csrf_field() {
...
/**
 * Checks if the user is authorized to access the admin page.
 * If the CSRF token is incorrect or the password is invalid, the user is redirected to the login page.
 * 
 * @return void
 */
function check_auth() {
